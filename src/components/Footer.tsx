              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  {/* <div 
                    ...
                    onClick={() => window.open('https://www.google.com/maps/search/?api=1&query=PSQ-C1-F04-011,+Emaar-The+Palm+Square,+Sector-66,+Golf+Course+Extension+Road,+Gurgaon,+Haryana-122102', '_blank')}
                  >
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs">Need help? Chat via WhatsApp</div>
                  </div>
                </Button>
              </div>
            </div>
